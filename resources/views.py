...
- |
    ...
    echo 'test ! -z $ALT_GATEWAY && (ip route del default via 192.168.1.1 || /bin/true; ip route add default via $ALT_GATEWAY || /bin/true)' >> /usr/local/bin/fix_subnet_routes.sh
